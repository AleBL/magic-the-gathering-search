...
/** Deck statistics in a modal, opened from a toolbar button instead of a tab. */
  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="deck-stats-title"
        className="modal-container sm:max-w-4xl w-full max-h-[90vh] overflow-y-auto animate-fadeIn"
      >
        <div className="flex items-center justify-between mb-4">
          <h3 id="deck-stats-title" className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
