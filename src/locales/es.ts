const es = {
  translations: {
    ...
    collection: {
      ...
      binderPages_one: 'Página {{pages}} de {{total}}',
      binderPages_other: 'Páginas {{pages}} de {{total}}',
      binderLayout: 'Bolsillos por página',
      binderPrevious_one: 'Página anterior',
      binderPrevious_other: 'Páginas anteriores',
      binderNext_one: 'Página siguiente',
      binderNext_other: 'Páginas siguientes',
