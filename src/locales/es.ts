const es = {
  translations: {
    ...
    deck: {
      ...
      compareDecks: 'Comparar Mazos',
      compareDeckA: 'Mazo A',
      compareDeckB: 'Mazo B',
      comparePickTwo: 'Elige dos mazos diferentes para comparar.',
      compareIdentical: 'Estos mazos tienen las mismas cartas.',
      compareOnlyIn: 'Solo en {{name}}',
      compareChanged: 'Copias cambiadas',
