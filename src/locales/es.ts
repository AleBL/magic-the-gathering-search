const es = {
  translations: {
    ...
    deck: {
      ...
      versionAutoHint: 'Se guarda una instantánea automáticamente cada vez que el mazo cambia.',
      versionChanges: 'Cambios',
      versionFirst: 'Primera instantánea — nada que comparar.',
      versionNoChanges: 'Sin cambios respecto a la instantánea anterior.',
      changeAdded: 'Añadida',
      ...
      deleteVersion: 'Eliminar instantánea',
      noVersions: 'Aún no hay instantáneas.',
