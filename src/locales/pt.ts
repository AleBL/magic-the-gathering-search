const pt = {
  translations: {
    ...
    search: {
      ...
      ownership: 'Coleção',
      loadingMoreFiltered: 'Carregando mais resultados para filtrar…',
      ownershipAll: 'Todas',
      ...
      cmcPlaceholder: 'Ex: 3',
      textAndStats: 'Texto e atributos',
      any: 'Qualquer',
      containsText: 'Contém o texto',
      containsTextPlaceholder: 'Ex: comprar um card',
      textLanguageHint: 'Busca no texto da carta no idioma que você está usando; palavras em inglês também funcionam.',
      excludesText: 'Não contém',
      excludesTextPlaceholder: 'Ex: voar',
      keyword: 'Palavra-chave',
      oracleTag: 'Função',
      oracleTagHint: 'Tags da comunidade: acha cartas que *são* remoção, não cartas que contêm a palavra.',
      power: 'Poder',
      ...
      oracleTags: {
        removal: 'Remoção',
        spotRemoval: 'Remoção pontual',
        boardWipe: 'Remoção em massa',
        ramp: 'Aceleração de mana',
        manaRock: 'Artefato de mana',
        manaDork: 'Criatura de mana',
        draw: 'Compra de cards',
        cardAdvantage: 'Vantagem de cards',
        cantrip: 'Cantrip',
        tutor: 'Tutor',
        counterspell: 'Anulação',
        recursion: 'Recursão',
        graveyardHate: 'Anti-cemitério',
        protection: 'Proteção',
        sacrificeOutlet: 'Sacrificador',
        landsMatter: 'Foco em terrenos',
    ...
    collection: {
      ...
      ownedValue: 'Valor das cópias que tenho',
      wishlistValue: 'Valor da lista de desejos',
      wishlistCards: 'Cartas desejadas',
      set: 'Edição',
      cardName: 'Carta',
      quantityShort: 'Qtd',
      quantity: 'Quantidade',
      ...
      binderLayout: 'Bolsos por página',
      binderPrevious: 'Página anterior',
      binderNext: 'Próxima página',
      ownedCount: '{{count}} possuídas',
      searchLabel: 'Buscar',
