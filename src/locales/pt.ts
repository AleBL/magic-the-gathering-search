const pt = {
  translations: {
    ...
    deck: {
      ...
      saveSnapshot: 'Salvar Instantâneo',
      restoreVersion: 'Restaurar',
      deleteVersion: 'Excluir instantâneo',
      noVersions: 'Ainda não há instantâneos.',
      versionCards: '{{n}} cartas',
      compareDecks: 'Comparar Decks',
      compareDeckA: 'Deck A',
      compareDeckB: 'Deck B',
      comparePickTwo: 'Escolha dois decks diferentes para comparar.',
      compareIdentical: 'Estes decks têm as mesmas cartas.',
      compareOnlyIn: 'Apenas em {{name}}',
      compareChanged: 'Cópias alteradas',
