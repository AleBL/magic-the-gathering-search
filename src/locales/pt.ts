const pt = {
  translations: {
    ...
    deck: {
      ...
      versionAutoHint: 'Um instantâneo é salvo automaticamente sempre que o deck muda.',
      versionChanges: 'Alterações',
      versionFirst: 'Primeiro instantâneo — nada a comparar.',
      versionNoChanges: 'Sem alterações em relação ao instantâneo anterior.',
      ...
      deleteVersion: 'Excluir instantâneo',
      noVersions: 'Ainda não há instantâneos.',
