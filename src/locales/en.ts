const en = {
  translations: {
    ...
    collection: {
      ...
      viewBySet: 'By set',
      viewBinder: 'Binder',
      binderPage: 'Page {{page}} of {{total}}',
      binderSheet: 'Page {{page}}',
      binderSpread: 'Spread {{spread}} of {{total}} · {{pages}} pages',
      binderLayout: 'Pockets per page',
      binderPrevious: 'Previous page',
