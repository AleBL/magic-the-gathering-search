const en = {
  translations: {
    ...
    deck: {
      ...
      compareDecks: 'Compare Decks',
      compareDeckA: 'Deck A',
      compareDeckB: 'Deck B',
      comparePickTwo: 'Pick two different decks to compare.',
      compareIdentical: 'These decks have the same cards.',
      compareOnlyIn: 'Only in {{name}}',
      compareChanged: 'Changed copies',
