const en = {
  translations: {
    ...
    collection: {
      ...
      binderPages_one: 'Page {{pages}} of {{total}}',
      binderPages_other: 'Pages {{pages}} of {{total}}',
      binderLayout: 'Pockets per page',
      binderPrevious_one: 'Previous page',
      binderPrevious_other: 'Previous pages',
      binderNext_one: 'Next page',
      binderNext_other: 'Next pages',
