const en = {
  translations: {
    ...
    deck: {
      ...
      versionAutoHint: 'A snapshot is saved automatically whenever the deck changes.',
      versionChanges: 'Changes',
      versionFirst: 'First snapshot — nothing to compare.',
      versionNoChanges: 'No changes from the previous snapshot.',
      changeAdded: 'Added',
